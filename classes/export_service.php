...
class export_service {
     ...
     * @param int|pdf_options $options Rendering options, or a page break mode constant.
     * @param int $userid    Owner of the resulting stored_file.
     * @param int $cmid      Quiz course module ID.
     * @return stored_file
     */
    public function export_single(int $attemptid, $options, int $userid, int $cmid): stored_file {
        ...
        $pdffile = $exporter->a2pdf($attemptobj, $options);
     ...
     * @return stored_file
     */
    public function export_bulk(array $attemptids, $options, int $userid, int $cmid): stored_file {
        global $DB;
